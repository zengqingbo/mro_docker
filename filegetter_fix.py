...
def getmrnicfg():
	mrnicfg =[]
	with open(os.path.join(CUR_DIR,'mrnicfg1.csv'),mode='r',encoding='gbk') as csvfile:
...
def mrgetter_main():
	if getDiskFreeGB(FTP_DL_DIR) > 500 :
		mroHourFilegetter(hours=getDay(2018,3,22))	
		mroHourFilegetter(hours=getDay(2018,3,23))	
		mroHourFilegetter(hours=getDay(2018,3,24))	
		mroHourFilegetter(hours=getDay(2018,3,25))	
		mroHourFilegetter(hours=getDay(2018,3,26))	
