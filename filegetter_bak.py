...
BAKDIR = '/gpdir/databak/LTE-MR/201708/'
VENDERDIR={
...
VALIDDATE = [datetime(year=2017,month=8,day=19),
			datetime(year=2017,month=8,day=18),
			datetime(year=2017,month=8,day=17),
			datetime(year=2017,month=8,day=5),
			datetime(year=2017,month=8,day=4),
			datetime(year=2017,month=8,day=3),
			]
...
if __name__ == '__main__':
	#getterfile()
	handleBigZipfile.delay('/Users/zengqingbo/Downloads/TD-LTE_MRO_HUAWEI_010031151066-010025089076_20170908080000_002.zip',1)
